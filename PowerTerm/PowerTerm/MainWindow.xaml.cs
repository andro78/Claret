...
namespace PowerTerm
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        /// <summary>
        /// Opens the manual, which ships beside the exe — no network, and no link to a repository
        /// this build may not have. When Windows has nothing registered for a .md file, the path is
        /// shown instead, since a dialog naming the file beats a handler-picker nobody asked for.
        /// </summary>
        private async void OnHelpManualClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                Title = "Manual",
                Content = File.Exists(local)
                    ? $"Nothing on this machine opens a .md file. The manual is at:\n\n{local}"
                    : "The manual is not in this build. It lives at docs\\MANUAL.md in the source.",
                CloseButtonText = "Close",
            });
        }
